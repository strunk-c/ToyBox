(() => {
  let q = {
    ...
    ai = (s) => {
      ...
      for (i = s.length; i--;)
        (s[i] && (s[i]._gsap || (s[i]._gsap = new Rt(s[i], t)))) ||
          s.splice(i, 1);
      return s;
    },
    ...
    ni = (s, e, t) =>
      (t = s[e]) && W(t)
        ? s[e]()
        : (bt(t) && s.getAttribute && s.getAttribute(e)) || t,
    ...
    ns = (s) => {
      let e = parseFloat(s);
      return (e || e === 0) && (s + "").match(Ki).length < 2
        ? e
        : j(s)
          ? s.trim()
          : s;
    ...
    Ct = (s) => {
      let e = s.parent || B,
        t = s.keyframes ? Ar : he;
      if (Z(s.inherit))
        for (; e;) t(s, e.vars.defaults), (e = e.parent || e._dp);
      return s;
    },
    kr = (s, e) => {
      let t = s.length,
    ...
    ls = (s) =>
      s._repeat ? Ze(s._tTime, (s = s.duration() + s._rDelay)) * s : 0,
    Ze = (s, e) => {
    ...
    li = (s) =>
      (s._end = S(s._start + (s._tDur / Math.abs(s._ts || s._rts || D) || 0))),
    ds = (s, e) => {
      let t = s._dp;
      return (
        t &&
        ...
        ((s._start = S(
          ...
          (s._ts > 0
            ? e / s._ts
            : ((s._dirty ? s.totalDuration() : s._tDur) - e) / -s._ts)
        )),
          li(s),
          t._dirty || Ne(t, s)),
        s
    ...
    Dt = (s, e) => {
      ...
      if (
        ((e._time || (e._initted && !e._dur)) &&
          ((t = Et(s.rawTime(), e)),
            (!e._dur || ut(0, e.totalDuration(), t) - e._tTime > D) &&
            e.render(t, !0)),
    ...
    us = (s, e) =>
      (te.ScrollTrigger || Tt("scrollTrigger", e)) &&
      te.ScrollTrigger.create(e, s),
    fs = (s, e, t, i) => {
    ...
    ps = ({ parent: s }) =>
      s && s._ts && s._initted && !s._lock && (s.rawTime() < 0 || ps(s)),
    Vr = (s, e, t, i) => {
      let r = s.ratio,
        a =
          e < 0 ||
      ...
      if (
        ...
        s._startAt && e < 0 && s._startAt.render(e, !0, !0),
          ...
          (a && De(s, 1),
            t ||
            (se(s, a ? "onComplete" : "onReverseComplete", !0),
              s._prom && s._prom()));
    ...
    Br = (s, e, t = []) =>
      s.forEach((i) =>
        (j(i) && !e) || _s(i, 1) ? t.push(...xe(i)) : t.push(i)
      ) || t,
    xe = (s, e) =>
      j(s) && !e && (ei || !Je())
        ...
        (c, p, f) => {
          ...
          if (!g) {
            if (((P = e.grid === "auto" ? 0 : (e.grid || [1, _e])[1]), !P)) {
              for (
                w = -_e;
                w < (w = f[P++].getBoundingClientRect().left) && P < u;
    ...
    bs = (s, e, t, i) =>
      Le(ne(s) ? !e : t === !0 ? !!(t = 0) : !i, () =>
        ne(s)
          ...
          Math.floor(
            Math.round((s - t / 2 + Math.random() * (e - s + t * 0.99)) / t) *
            t *
            i
          ) / i
      ),
    ...
    Ss = (s, e, t, i) => {
      ...
      if (!r) {
        ...
        if ((t === !0 && (i = 1) && (t = null), a))
          ...
          for (h = [], d = s.length, c = d - 2, l = 1; l < d; l++)
            h.push(Ss(s[l - 1], s[l]));
          d--,
            (r = (p) => {
              p *= d;
    ...
    Cs = (s, e, t) => {
      ...
      for (a in i)
        (n = i[a] - e),
          n < 0 == !!t && n && r > (n = Math.abs(n)) && ((o = a), (r = n));
      return o;
    },
    se = (s, e, t) => {
      let i = s.vars,
    ...
    Ms = (s, e, t) => {
      let i = s ? (ue(s) ? [s >> 16, (s >> 8) & O, s & O] : 0) : pt.black,
        ...
        f;
      if (!i) {
        if ((s.substr(-1) === "," && (s = s.substr(0, s.length - 1)), pt[s]))
          i = pt[s];
        else if (s.charAt(0) === "#") {
          if (
            (s.length < 6 &&
              ((r = s.charAt(1)),
                ...
                (s =
                  ...
                  n +
                  n +
                  (s.length === 5 ? s.charAt(4) + s.charAt(4) : ""))),
              s.length === 9)
          )
            return (
          ...
          if (((i = f = s.match(Zt)), !e))
            ...
            return (i = s.match(Kt)), t && i.length < 4 && (i[3] = 1), i;
    ...
    Ds = (s, e, t) => {
      ...
      if (!l)
        for (l = s.split(tt), d = l.length - 1; n < d; n++) i += l[n] + r[n];
      return i + l[d];
    },
    tt = (function () {
      let s =
    ...
    Jr = (s) => {
      ...
      return t && e.length > 1 && t.config
        ? t.config.apply(
          null,
          ~s.indexOf("{") ? [Zr(e[1])] : Kr(s).split(",").map(ns)
        )
        : Y._CE && qr.test(s)
          ? Y._CE("", s)
          : t;
    ...
    We = (
      ...
      return (
        J(s, (n) => {
          ...
          for (let o in r)
            Y[
              a + (o === "easeIn" ? ".in" : o === "easeOut" ? ".out" : ".inOut")
            ] = Y[n + "." + o] = r[o];
        }),
        r
      );
    ...
    Ls = (s) => (e) =>
      e < 0.5 ? (1 - s(1 - e * 2)) / 2 : 0.5 + s((e - 0.5) * 2) / 2,
    Ot = (s, e, t) => {
      let i = e >= 1 ? e : 1,
  ...
  let Rt = class {
    ...
    it = class {
      ...
      time(e, t) {
        return arguments.length
          ? this.totalTime(
            Math.min(this.totalDuration(), e + ls(this)) % this._dur ||
            (e ? this._dur : 0),
            t
          )
          : this._time;
      ...
      startTime(e) {
        if (arguments.length) {
          ...
          return (
            t && (t._sort || !this.parent) && Pe(t, this, e - this._delay), this
          );
        }
        return this._start;
      }
      endTime(e) {
        return (
          this._start +
          (Z(e) ? this.totalDuration() : this.duration()) / Math.abs(this._ts)
        );
      }
      rawTime(e) {
        let t = this.parent || this._dp;
      ...
      reversed(e) {
        return arguments.length
          ? (!!e !== this.reversed() &&
            this.timeScale(-this._rts || (e ? -D : 0)),
            this)
          : this._rts < 0;
      }
      invalidate() {
  ...
  let G = class extends it {
    ...
    to(e, t, i) {
      return (
        new L(e, dt(arguments, 0, this), H(this, ue(t) ? arguments[3] : i)),
        this
      );
    }
    from(e, t, i) {
      return (
        new L(e, dt(arguments, 1, this), H(this, ue(t) ? arguments[3] : i)),
        this
      );
    }
    fromTo(e, t, i, r) {
      return (
        new L(e, dt(arguments, 2, this), H(this, ue(t) ? arguments[4] : r)),
        this
      );
    }
    set(e, t, i) {
    ...
    render(e, t, i) {
      ...
      if (o !== this._tTime || i || l) {
        ...
        if (
          ...
          for (d = this._first; d;) {
            if (
              ((c = d._next), (d._act || h >= d._start) && d._ts && g !== d)
            ) {
    ...
    addPause(e, t, i) {
      ...
      return (
        (r.data = "isPause"), (this._hasPause = 1), Pe(this, r, H(this, e))
      );
    }
    removePause(e) {
      let t = this._first;
      for (e = H(this, e); t;)
        t._start === e && t.data === "isPause" && De(t), (t = t._next);
    }
    killTweensOf(e, t, i) {
  ...
  let $r = function (s, e, t, i, r, a, n) {
    ...
    ci = function (s, e, t, i, r, a, n, o, l) {
        ...
        d =
          t !== "get"
            ...
            : W(h)
              ? l
                ? s[
                  e.indexOf("set") || !W(s["get" + e.substr(3)])
                    ? e
                    : "get" + e.substr(3)
                ](l)
                : s[e]()
      ...
      if (
        ...
        return isNaN(d * i)
          ? (!h && !(e in s) && Tt(e, i),
            $r.call(this, s, e, d, i, c, o || q.stringFilter, l))
          : ((p = new X(
            this._pt,
            s,
            e,
    ...
    xi = (s, e, t, i, r, a) => {
      ...
      if (
        ...
        (n = new K[s]()).init(
          r,
          n.rawVars ? e[s] : ia(e[s], i, r, a, t),
          t,
          i,
          a
        ) !== !1 &&
        ((t._pt = o = new X(t._pt, r, s, 0, 1, n.render, n, 0, n.priority)),
          t !== et)
      )
        for (l = t._ptLookup[t._targets.indexOf(r)], h = n._props.length; h--;)
          l[n._props[h]] = o;
      return n;
    },
    Ae,
    cs = (s, e) => {
      ...
      if (
        (m && (!p || !i) && (i = "none"),
          ...
          s._yoyo &&
          !s._repeat &&
          ((c = s._yEase), (s._yEase = s._ease), (s._ease = c)),
          !m)
      ) {
        if (
        ...
        for (
          ...
          if (
            ((C = _[w]),
              ...
              ((s._pt = P =
                new X(s._pt, C, k.name, 0, 1, k.render, k, 0, k.priority)),
                k._props.forEach((pe) => {
                  U[pe] = P;
                }),
                k.priority && (E = 1)),
            ...
            for (b in y)
              K[b] && (k = xi(b, y, s, V, C, x))
                ? k.priority && (E = 1)
                : (U[b] = P =
                  ci.call(s, C, b, "get", y[b], V, x, 0, t.stringFilter));
    ...
    sa = (s, e) => {
      ...
      for (a in i)
        if (a in r)
          for (o = i[a].split(","), n = o.length; n--;) r[o[n]] = r[a];
      return r;
    },
    gt = (s, e, t, i, r) =>
      W(s) ? s.call(e, t, i, r) : j(s) && ~s.indexOf("random(") ? ct(s) : s,
    Os = ri + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase",
    ra = (Os + ",id,stagger,delay,duration,paused,scrollTrigger").split(","),
    L = class extends it {
      constructor(e, t, i, r) {
        typeof t == "number" && ((i.duration = t), (t = i), (i = null)),
          super(r ? t : Ct(t), i);
        let {
          duration: a,
          delay: n,
      ...
      kill(e, t = "all") {
        ...
        if (this.timeline) {
          ...
          return (
            this.timeline.killTweensOf(e, t, Ae && Ae.vars.overwrite !== !0)
              ._first || ft(this),
            this.parent &&
        ...
        let i = this._targets,
          ...
          f;
        if ((!t || t === "all") && kr(i, r))
          return t === "all" && (this._pt = 0), ft(this);
        for (
          o = this._op = this._op || [],
          t !== "all" &&
          (j(t) && ((c = {}), J(t, (u) => (c[u] = 1)), (t = c)),
            (t = sa(i, t))),
          f = i.length;
          f--;
  ...
  let Vt = {
    ...
    registerEffect({
      ...
      (t || "")
        ...
        .forEach(
          (a) =>
            a && !K[a] && !te[a] && ts(s + " effect requires " + a + " plugin.")
        ),
  ...
  let Fs,
    ...
    Us = (s, e) =>
      e.set(e.t, e.p, Math.round((e.s + e.c * s) * 1e4) / 1e4 + e.u, e),
    ca = (s, e) =>
      e.set(
        e.t,
        e.p,
        s === 1 ? e.e : Math.round((e.s + e.c * s) * 1e4) / 1e4 + e.u,
        e
      ),
    fa = (s, e) =>
      e.set(
        e.t,
        e.p,
        s ? Math.round((e.s + e.c * s) * 1e4) / 1e4 + e.u : e.b,
        e
      ),
    pa = (s, e) => {
      let t = e.s + e.c * s;
        ...
        : (a !== "px" && !c && (r = Re(s, e, t, "px")),
          ...
          (p || a === "%") && (ke[e] || ~e.indexOf("adius"))
            ...
            : ((n[o ? "width" : "height"] = d + (c ? a : i)),
              (u =
                ~e.indexOf("adius") || (i === "em" && s.appendChild && !l)
                  ? s
                  : s.parentNode),
    ...
    ba = function (s, e, t, i) {
      if (!t || t === "none") {
        ...
        y && y !== t
          ? ((e = m), (t = y))
          : e === "borderColor" && (t = ve(s, "borderTopColor"));
      }
      ...
      if (
        ((r.b = t),
          ...
          (i += ""),
          i === "auto" &&
          ((s.style[e] = i), (i = ve(s, e) || i), (s.style[e] = t)),
          (o = [t, i]),
          gi(o),
          (t = o[0]),
          (i = o[1]),
      ...
      if (e.tween && e.tween._time === e.tween._dur) {
        ...
        if (r === "all" || r === !0) (i.cssText = ""), (o = 1);
          ...
          for (r = r.split(","), l = r.length; --l > -1;)
            (n = r[l]),
              ke[n] && ((o = 1), (n = n === "transformOrigin" ? Fe : re)),
              It(t, n);
        o &&
          (It(t, re),
            a &&
            (a.svg && t.removeAttribute("transform"),
              Bt(t, 1),
              (a.uncache = 1)));
      }
    },
      ...
      return t.svg && s.getAttribute("transform")
        ...
        : (r === mt &&
          ...
          ((o = i.display),
            ...
            (a = s.parentNode),
            (!a || !s.offsetParent) &&
            ((l = 1), (n = s.nextSibling), st.appendChild(s)),
            (r = Ks(s)),
    ...
    Ri = (s, e, t, i, r, a) => {
      ...
      t
        ...
        : ((y = Hs(s)),
          ...
          (m =
            y.y + (~(x[1] || x[0]).indexOf("%") ? (m / 100) * y.height : m))),
        i || (i !== !1 && n.smooth)
          ? ((_ = T - l),
            (v = m - h),
      ...
      return (
        ...
        (t.x =
          ...
          ((t.xPercent =
            l &&
            (t.xPercent ||
              (Math.round(s.offsetWidth / 2) === Math.round(-l) ? -50 : 0)))
        ...
        (t.y =
          ...
          ((t.yPercent =
            h &&
            (t.yPercent ||
              (Math.round(s.offsetHeight / 2) === Math.round(-h) ? -50 : 0)))
    ...
    Ca = (s, e, t) => {
      let i = _t.style,
        ...
        f;
      (i.cssText =
        getComputedStyle(t).cssText + ";position:absolute;display:block;"),
        (i[re] = e),
        ...
        if (
          ...
          if (
            ...
            if (
              (o && u in o
                ? ((l =
                  typeof o[u] == "function" ? o[u].call(t, i, s, r) : o[u]),
              ...
              if (
                (T ||
                  ((m = s._gsap),
                    (m.renderTransform && !e.parseTransform) ||
                    Bt(s, e.parseTransform),
                    (y = e.smoothOrigin !== !1 && m.smooth),
                    (T = this._pt =
                      new X(this._pt, n, re, 0, 1, m.renderTransform, m, 0, -1)),
                    (T.dep = 1)),
                  u === "scale")
              )
                (this._pt = new X(
  ...
  let ee = oe.registerPlugin(Ci) || oe,
    Dn = ee.core.Tween;
  ("use strict");
  let $s = 0,
    Mi = class {
                ...
                this._staggerEls.forEach((a) => {
                  ...
                  setTimeout(() => {
                    i.onElVisible && i.onElVisible(i),
                      (this._staggerEls = this._staggerEls.filter(
                        (a) => i.id !== a.id
                      ));
                  }, r);
              }
  ...
  let Ei = class {
    constructor({
      ...
      (this.container = e),
        ...
        (this.router = {
          history: [{ href: window.location.href, title: document.title }],
        }),
        (this.cache = []),
        (this._isLoading = !1),
        (this._ajaxCalls = 0),
    ...
    _handleClick(e) {
      let t = e.target;
      if ((t.name !== "A" && (t = t.closest("a")), !t)) return;
      ...
      (this._isLoading = !0),
        ...
        this._AJAXCall(e, t, (i, r) => {
          (this.router.nextHTMLContent = this._parseResponseContent(i)),
            (this.router.nextTitle = i.match(
              /<title[^>]*>([^<]+)<\/title>/
            )[1]),
            this.params.cacheNavigatedPages &&
            (this.cache.find((n) => n.href === e) ||
              this._cacheResponse(r, i));
        });
    }
    _AJAXCall(e, t, i) {
        ...
        e.target._depth
          ? (this.stacks.renderTargets.sort((t, i) => t.index - i.index),
            this.stacks.renderTargets.sort(
              (t, i) => i.renderOrder - t.renderOrder
            ))
          : (this.stacks.renderTargets.sort((t, i) => i.index - t.index),
            this.stacks.renderTargets.sort(
              (t, i) => t.renderOrder - i.renderOrder
            )),
          this.stacks.renderTargets.sort(
            (t, i) => t.target.index - i.target.index
          );
      else {
        let t = e._transparent ? this.stacks.transparent : this.stacks.opaque,
          i = this.stacks.scenePasses.find(
            (r, a) => r._isScenePass && !r._depth && a === 0
          );
        !this.renderer.depth || i
          ? (t.sort((r, a) => a.index - r.index),
            e._transparent &&
            t.sort(
              (r, a) => r.relativeTranslation.z - a.relativeTranslation.z
            ),
            t.sort((r, a) => r.renderOrder - a.renderOrder))
          : (t.sort((r, a) => r.index - a.index),
            e._transparent &&
            t.sort(
              (r, a) => a.relativeTranslation.z - r.relativeTranslation.z
            ),
            t.sort((r, a) => a.renderOrder - r.renderOrder));
      }
    }
  ...
  let Oi = class {
      ...
      if (t && i) {
        function r(a) {
          ...
          for (; a && !isNaN(a.offsetTop);)
            (n += a.offsetTop - a.scrollTop), (a = a.offsetParent);
          return n;
        }
    ...
    removeRenderTarget(e) {
      ...
      let t = this.planes.find(
        (i) =>
          i.type !== "PingPongPlane" && i.target && i.target.uuid === e.uuid
      );
      ...
      if (
        ...
        for (let r in i) {
          ...
          this.uniforms[r] = {
            ...
            type: a.type,
            value:
              a.value.clone && typeof a.value.clone == "function"
                ? a.value.clone()
                : a.value,
            update: null,
          };
...
`,
      ...
      createProgram() {
        ...
        if (
          ...
          let e = this.gl.getProgramParameter(
            this.program,
  ...
  let Q = class {
    ...
    multiply(e) {
      ...
      return (
        (r.elements[0] =
          i[0] * t[0] + i[1] * t[4] + i[2] * t[8] + i[3] * t[12]),
        (r.elements[1] =
          i[0] * t[1] + i[1] * t[5] + i[2] * t[9] + i[3] * t[13]),
        (r.elements[2] =
          i[0] * t[2] + i[1] * t[6] + i[2] * t[10] + i[3] * t[14]),
        (r.elements[3] =
          i[0] * t[3] + i[1] * t[7] + i[2] * t[11] + i[3] * t[15]),
        (r.elements[4] =
          i[4] * t[0] + i[5] * t[4] + i[6] * t[8] + i[7] * t[12]),
        (r.elements[5] =
          i[4] * t[1] + i[5] * t[5] + i[6] * t[9] + i[7] * t[13]),
        (r.elements[6] =
          i[4] * t[2] + i[5] * t[6] + i[6] * t[10] + i[7] * t[14]),
        (r.elements[7] =
          i[4] * t[3] + i[5] * t[7] + i[6] * t[11] + i[7] * t[15]),
        (r.elements[8] =
          i[8] * t[0] + i[9] * t[4] + i[10] * t[8] + i[11] * t[12]),
        (r.elements[9] =
          i[8] * t[1] + i[9] * t[5] + i[10] * t[9] + i[11] * t[13]),
        (r.elements[10] =
          i[8] * t[2] + i[9] * t[6] + i[10] * t[10] + i[11] * t[14]),
        (r.elements[11] =
          i[8] * t[3] + i[9] * t[7] + i[10] * t[11] + i[11] * t[15]),
        (r.elements[12] =
          i[12] * t[0] + i[13] * t[4] + i[14] * t[8] + i[15] * t[12]),
        (r.elements[13] =
          i[12] * t[1] + i[13] * t[5] + i[14] * t[9] + i[15] * t[13]),
        (r.elements[14] =
          i[12] * t[2] + i[13] * t[6] + i[14] * t[10] + i[15] * t[14]),
        (r.elements[15] =
          i[12] * t[3] + i[13] * t[7] + i[14] * t[11] + i[15] * t[15]),
        r
      );
    }
    getInverse() {
...
gl.LINEAR filtering will be used instead`
  ...
  let Ht = class {
    ...
    _getSourceType(e) {
      ...
      return (
        typeof e == "string"
          ? e.match(/\.(jpeg|jpg|jfif|pjpeg|pjp|gif|bmp|png|webp|svg)$/) !==
            null
            ? (t = "image")
    ...
    loadVideo(e, t = {}, i, r) {
      ...
      this._parent && (n = Object.assign(t, this._parent._texturesOptions)),
        (n.loader = this),
        (n.sampler = a.hasAttribute("data-sampler")
          ? a.getAttribute("data-sampler")
          : n.sampler);
      ...
      a.addEventListener("canplaythrough", l.load, !1),
        ...
        ((l.videoFrameCallback = o._videoFrameCallback.bind(o)),
          (o._videoFrameCallbackID = a.requestVideoFrameCallback(
...
`,
      ...
      for (let e = 0; e < this.textures.length; e++) {
        ...
        if (t.sourceType === "video") {
          ...
          i !== void 0 &&
            i.catch((r) => {
              this.renderer.production ||
                R(this.type + ": Could not play the video : ", r);
            });
        }
      }
    }
    _draw() {
      ...
      for (let e = 0; e < this.textures.length; e++)
        if (
          (this.textures[e]._draw(), !this.textures[e]._sampler.isTextureBound)
        )
          return;
      this._geometry.draw(),
  ...
  let nr = new N(),
    ...
    yt = class extends Bi {
      ...
      mouseToPlaneCoords(e) {
        ...
        return nr.set(
          ((e.x - r.left) / r.width) * 2 - 1,
          1 - ((e.y - r.top) / r.height) * 2
        );
      }
      onAfterResize(e) {
        return e && (this._onAfterResizeCallback = e), this;
        ...
        if (i.length === 1)
          i[0] === 0
            ? ((t[0] = this._getIntersection(
              t[1],
              le.set(0.95, 1, 0).applyMat4(r)
            )),
              t.push(
                this._getIntersection(t[3], de.set(-1, -0.95, 0).applyMat4(r))
              ))
            : i[0] === 1
              ? ((t[1] = this._getIntersection(
                ...
                t.push(
                  this._getIntersection(t[2], de.set(1, -0.95, 0).applyMat4(r))
                ))
              : i[0] === 2
                ? ((t[2] = this._getIntersection(
                  ...
                  t.push(
                    this._getIntersection(t[1], de.set(1, 0.95, 0).applyMat4(r))
                  ))
                : i[0] === 3 &&
                ((t[3] = this._getIntersection(
                  ...
                  t.push(
                    this._getIntersection(t[0], de.set(-1, 0.95, 0).applyMat4(r))
                  ));
        else if (i.length === 2)
          i[0] === 0 && i[1] === 1
            ? ((t[0] = this._getIntersection(
              t[3],
              le.set(-1, -0.95, 0).applyMat4(r)
            )),
              (t[1] = this._getIntersection(
                t[2],
                de.set(1, -0.95, 0).applyMat4(r)
              )))
            : i[0] === 1 && i[1] === 2
              ? ((t[1] = this._getIntersection(
                t[0],
          ...
          (t = [t[a]]),
            a === 0
              ? (t.push(
                this._getIntersection(t[0], le.set(-0.95, 1, 0).applyMat4(r))
              ),
                t.push(
                  this._getIntersection(t[0], de.set(-1, 0.95, 0).applyMat4(r))
                ))
          ...
          for (let a = 0; a < e.length; a++) (t[a][0] = 1e4), (t[a][1] = 1e4);
        return t;
      }
      _getWorldCoords() {
        let e = [
      ...
      mouseToPlaneCoords(e) {
          ...
          return super.mouseToPlaneCoords(e);
        {
          ...
          let n = Qa.set(0, 0, 0),
            o = a.dot(r);
          if (Math.abs(o) >= 1e-4) {
            let l = this._matrices.world.matrix
              .getInverse()
  ...
  let Yt = class {
    constructor({
      ...
      (this.plane = e),
        ...
        (this.plane.onAfterResize = (g) => (
          g && (this._onAfterResizeCallback = g), this.plane
        ));
    }
    setCanvasSize() {
    ...
    writeTexture(e = !0) {
      this.context.clearRect(0, 0, this.canvas.width, this.canvas.height),
        ...
        (this.context.font =
          ...
          this.content.style.fontWeight +
          " " +
          parseFloat(this.content.style.fontSize) *
          this.plane.renderer.pixelRatio +
          "px " +
          this.content.style.fontFamily),
        ...
        ((this.lines = []),
          this.content.words.forEach((c, p) => {
            this.content.style.textTransform === "uppercase"
              ...
              : this.content.style.textTransform === "lowercase" &&
              (c.word = c.word.toLowerCase()),
              this.onBeforeWordMeasuring &&
              this.onBeforeWordMeasuring(this.context, c, p);
            let f = this.context.measureText(c.word).width;
            this.onAfterWordMeasuring &&
              this.onAfterWordMeasuring(this.context, c, p),
              ((p > 0 &&
                l.x + f >
                this.content.innerBoundingRect.width +
                this.content.innerBoundingRect.left +
      ...
      this.content.verticalAlign === "center"
        ...
        this.lines.forEach((c, p) => {
          c.forEach((f) => {
            let u =
              c[0].position.x +
              c[c.length - 1].position.x +
              c[c.length - 1].wordWidth -
              t;
...
`,
  ...
  let Gi = class {
    ...
    onMouseMove(e) {
      if (this.ripples) {
        ...
        if (
          ((this.ripples.uniforms.mousePosition.value = t),
    ...
    addRipples() {
      (this.ripples = new Xt(
        this.curtains,
        document.getElementById("ripples"),
        {
          vertexShader: hr,
          fragmentShader: lr,
          autoloadSources: !1,
          ...
          uniforms: {
            ...
            viscosity: { name: "uViscosity", type: "1f", value: 10.75 },
        ...
        this.ripples
          ...
          .onAfterResize(() => {
            ...
            this.ripples.uniforms.resolution.value.set(e.width, e.height),
              (this.ripples.uniforms.dissipation.value = this.isPortrait
                ? 0.985
                : 0.9875);
          });
    }
    addRenderPasses() {
          ...
          .onRender(() => {
            this.smoothScroll ||
              ((this.scroll.lastValue = this.scroll.value),
                ...
                (this.scrollPass.uniforms.scrollEffect.value =
                  this.scroll.effect));
          })
          .onAfterResize(() => {
            let i = this.scrollPass.getBoundingRect();
            this.scrollPass.uniforms.scrollStrength.value =
              i.width >= i.height ? 1.5 : 3;
          });
      let e = {
        resolution: {
          name: "uResolution",
      ...
      this.curtains.isWebGL2() &&
        ((t.vertexShader = Tr), (t.fragmentShader = Pr)),
    ...
    removePlanes() {
      this.curtains.planes.forEach((e) => {
        e.type !== "PingPongPlane" &&
          ...
          (e.userData.tween &&
            (e.userData.tween.kill(), (e.userData.tween = null)),
            e.userData.mouseEl &&
            e.userData.mouseEnter &&
            e.userData.mouseEl.removeEventListener(
              "mouseenter",
              e.userData.mouseEnter
            ),
            e.userData.mouseEl &&
    ...
    addSingleTextPlane(e) {
      let t = e.classList.contains("main-title-text"),
        ...
        l =
          o ||
          (e.hasAttribute("id") && e.getAttribute("id") === "scroll-to-top"),
      ...
      h.setRenderTarget(this.scrollTarget),
        ...
        n &&
        e.querySelectorAll("a").forEach((f) => {
          let u = f.textContent;
          f.innerText = u
            .replace(/[\n\r]+|[\s]{2,}/g, " ")
            .trim()
      ...
      o &&
        ((h.userData.isHovered = !1),
          ...
          ((h.userData.mouseEnter = () => {
            ...
            h.userData.mouseEl.addEventListener(
              "mouseenter",
              h.userData.mouseEnter
            ),
            h.userData.mouseEl.addEventListener(
    ...
    addSingleHRPlane(e) {
      let t =
        e.classList.contains("site-list-separator") ||
          e.classList.contains("project-separator")
          ? 0.5
          : 1,
        i = new be(this.curtains, e, {
          vertexShader: cr,
    ...
    addSingleRegularPlane(e) {
      let t = e.classList.contains("main-project-plane"),
        ...
        r = e.hasAttribute("data-min-opacity")
          ? e.getAttribute("data-min-opacity")
          : 1,
        ...
        n = new be(this.curtains, e, {
          ...
          uniforms: {
            ...
            grayScale: { name: "uIsGrayScale", type: "1f", value: t ? 1 : 0 },
      ...
      n.setRenderTarget(this.scrollTarget),
        ...
        ((n.userData.hoverDuration = 2.5),
          ...
          this.isMobile ||
          ((n.userData.mouseEl = e.closest("a")),
            (n.userData.mouseEnter = () => {
              (n.userData.isHovered = !0),
                this.isPortrait || (n.visible = !0),
                n.userData.tween &&
                (n.userData.tween.kill(), (n.userData.tween = null));
              let o = {
            ...
            n.userData.mouseEl.addEventListener(
              "mouseenter",
              n.userData.mouseEnter
            ),
            n.userData.mouseEl.addEventListener(
  ...
  let Hi = class {
    ...
    resize() {
      ...
      (this.scroll = { target: e, current: e, velocity: 0 }),
        this.scrollTo(this.scroll.current);
    }
    lerp(e, t, i) {
    ...
    scrollTo(e) {
      (e = Math.max(
        0,
        Math.min(e, this.store.documentHeight - this.store.windowHeight)
      )),
  ...
  let Rr = class {
      ...
      (this.production = e),
        (this.state = {
          ...
          fonts: {
            loaded: 0,
            list: [
              'normal 400 1em "MonumentExtended Regular", Arial, sans-serif',
              'normal 400 1em "MonumentExtended UltraBold", Arial, sans-serif',
              'normal 400 1em "Swiss", serif',
            ],
          },
        }),
        this.checkPerf(),
    ...
    init() {
      this.initStore(),
        ...
        this.production &&
        (console.log(
          "%cHey there fellow dev friend!",
          'font-size: 14px; color: #111111; font-weight: 700; font-family: "Swiss", Arial, sans-serif;'
        ),
          console.log(
            "%cHere is a complete list of all the libs used on this website:",
            'font-size: 14px; color: #111111; font-family: "Swiss", Arial, sans-serif;'
          ),
          console.log(
            "%cPJAX router: https://github.com/martinlaxenaire/pjax-router",
            'font-size: 14px; color: #111111; font-family: "Swiss", Arial, sans-serif;'
          ),
          console.log(
            "%cSmooth scroll: https://github.com/martinlaxenaire/native-smooth-scroll",
            'font-size: 14px; color: #111111; font-family: "Swiss", Arial, sans-serif;'
          ),
          console.log(
            "%cScroll observer: https://github.com/martinlaxenaire/scroll-observer",
            'font-size: 14px; color: #111111; font-family: "Swiss", Arial, sans-serif;'
          ),
          console.log(
            "%ccurtains.js: https://github.com/martinlaxenaire/curtainsjs",
            'font-size: 14px; color: #111111; font-family: "Swiss", Arial, sans-serif;'
          ),
          console.log(
            "%cGSAP: https://github.com/greensock/GSAP",
            'font-size: 14px; color: #111111; font-family: "Swiss", Arial, sans-serif;'
          )),
      ...
      this.state.fonts.list.forEach((e) => {
        document.fonts.load(e).then(() => {
          this.state.fonts.loaded++,
            this.state.fonts.loaded === this.state.fonts.list.length &&
    ...
    addEvents(e) {
      for (let [t, i] of Object.entries(e))
        this.listeners[t].push({ callback: i });
    }
    emitEvent(e, t = {}) {
    ...
    onScroll(e) {
      (this.store.scroll = { x: 0, y: e.current }),
    ...
    setNameSpace() {
      this.state.namespace =
        document.getElementById("content").getAttribute("data-namespace") ||
        "home";
    }
    startRouting() {
      this.router = new Ei({
    ...
    onPageLoad() {
        ...
        let e = (performance || Date).now(),
          t =
            e - this.state.loader.startTs > this.state.loader.minDuration
              ? 0
              : this.state.loader.minDuration -
              (e - this.state.loader.startTs);
        setTimeout(() => {
          this.perf > this.state.webglPerfThreshold &&
            (this.state.loader.el.classList.remove("shown"),
              this.startMainObserver());
      ...
      (this.state.loader.loaded = !0),
        ...
        this.state.scrollTopButton &&
        this.state.scrollTopButton.addEventListener(
          "click",
            ...
            e.el.classList.contains("main-title-text") && (e.stagger = 100),
              e.el.classList.contains("site-list-separator")
                ...
                : e.el.closest(".site-list-right-content") ||
                  ...
                  ? (e.stagger = 50)
                  : e.el.classList.contains("text-plane-is-link") &&
                  (e.stagger = 150),
          ...
          onElVisible: (e) => {
            if (this.webglLayer) {
              let t =
                ...
                this.webglLayer.curtains.planes.find((i) =>
                  i.htmlElement.isSameNode(e.el)
                );
