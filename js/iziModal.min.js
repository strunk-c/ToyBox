!(function (t) {
  ...
  return (
    (c.prototype = {
        ...
        function n() {
          s.$element
            ...
            .on("click", "[data-" + r + "-close]", function (e) {
              e.preventDefault();
              let i = t(e.currentTarget).attr("data-" + r + "-transitionOut");
      ...
      close: function (e) {
        ...
        if (this.state == l.OPENED || this.state == l.OPENING) {
          ...
          let o = this.options.transitionOut;
          "object" == typeof e &&
          ...
          setTimeout(function () {
            for (
              ...
              if ((o == i.group.ids.length && e > 0) || i.options.loop === !0)
                for (let l = 0; l <= i.group.ids.length; l++)
                  if (
          ...
          setTimeout(function () {
            for (
              ...
              if ((0 === o && e > 0) || i.options.loop === !0)
                for (let l = i.group.ids.length - 1; l >= 0; l--)
                  if (
                    ((a["in"] = t("#" + i.group.ids[l]).data().iziModal),
                      "undefined" != typeof a["in"])
                  ) {
      ...
      stopLoading: function () {
        let t = this.$element.find("." + r + "-loader");
        t.length ||
    ...
    (t.fn[r].defaults = {
      ...
      overlay: !0,
      overlayClose: !0,
      overlayColor: "rgba(201, 212, 216, 1)",
      timeout: !1,
